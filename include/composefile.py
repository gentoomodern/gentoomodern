...
class composefile:
    ...
    def create(output_path):
        ...
        lines.extend(self.__output_config(builder_str, self.arch))
        lines.extend(self.__output_config(packer_str, self.arch))
        lines.extend(self.__output_config(updater_str, self.arch))
    ...
    def __output_config(self, container_type_str):
        ...
        results.append('    image: localhost:5000/gentoomuch-' + self.arch + '-current\n')
