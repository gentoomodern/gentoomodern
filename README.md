...
<ol>
<li>Your workflow will change a bit. Mostly it'll mean creating subdirectories for your sets of packages/flags and then defining your machines from these sets, instead of directly within
<pre>/etc/portage</pre>, Also, you now access your build environments by going
<pre>gentoomuch freshroot</pre>
</li>
